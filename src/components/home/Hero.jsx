...
import myPhoto from "../../assets/studiopix.png";
  ...
  return (
    ...
    {/* 👇 I used this div below to create a space btwn the header and the hero */}
      ...
      <section className="pt-14 md:pt-0 lg:h-[80vh] xl:h-[90vh] relative z-0 bg-white dark:bg-darkBgLight">
        {/* Floating text 👇*/}
        <p className="hidden lg:block absolute top-32 -left-12 rotate-90 text-7xl font-semibold italic opacity-5 text-yellow-500 dark:text-yellow-500">
          LEXVEN
        </p>
        {/* Floating text ☝*/}
        ...
        <div className="container mx-auto px-4 md:flex h-full">
          ...
          <div className="flex flex-col justify-end pt-24 pb-6 lg:justify-center xl:justify-end xl:pb-20 md:w-[50%] lg:pl-24 md:font-medium">
            {/* Texts container 👇*/}
            <div className="left-anime text-yellow-500 dark:text-yellow-500">
            ...
            <div>
              <a
                href={resume}
                download={resume}
                className="mt-6 text-yellow-500 btn rounded-none bg-inherit border-yellow-500 lg:btn-lg hover:bg-yellow-500 hover:text-white"
              >
                Download CV
              </a>
            </div>
          ...
          <div className="h-full hidden md:block z-30 ">
            <img src={myPhoto} alt="" className="h-full hover:grayscale transition-all duration-300" />
          </div>
