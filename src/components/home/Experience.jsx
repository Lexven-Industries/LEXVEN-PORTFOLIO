...
function Experience() {
  ...
  return (
    <section className="text-yellow-500 dark:yellow-500 relative bg-white dark:bg-darkBgLight" id="experience">
      {/* Floating Text 👇 */}
      ...
      <div className="container mx-auto px-6 py-28">
        ...
        <p className="text-4xl pb-10 md:text-5xl text-yellow-500 dark:text-yellow-500">
          Experience
        </p>
          ...
          {experienceData.map((experience, index) => (
            <div key={index} className="border-t-[0.2px] border-borderColor py-5 lg:py-10">
              <div>
                ...
                <p className="py-4 text-yellow-300 text-lg">{experience.duration}</p>
              </div>
              <ul>
